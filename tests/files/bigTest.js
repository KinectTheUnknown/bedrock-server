...
exports.simplified = {
  longTest: BigInt(2) ** BigInt(63) - BigInt(1),
  shortTest: 32767,
  ...
  "listTest (compound)": [
    {
      name: "Compound tag #0",
      "created-on": BigInt("1264099775885")
    },
    {
      name: "Compound tag #1",
      "created-on": BigInt("1264099775885")
  ...
  byteTest: 127,
  //eslint-disable-next-line max-len
  "byteArrayTest (the first 1000 values of (n*n*255+n*7)%100, starting with n=0 (0, 62, 34, 16, 8, ...))": Int8Array.from([
    0,
    62,
    34,
    16,
